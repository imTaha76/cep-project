document.addEventListener('DOMContentLoaded', () => {
    ...
    if (countdownTimer) {
        ...
        // All other event logic remains the same...
        ...
        const updateCountdown = () => {
            ...
            if (distance < 0) {
                ...
                if(eventPreContent) eventPreContent.classList.add('hide');
                if(eventPostContent) eventPostContent.classList.remove('hide');
                return;
            }
    ...
    if (quizContainer) {
        ...
        const selectAnswer = (e) => {
            ...
            e.target.classList.add(e.target.dataset.correct ? 'correct' : 'incorrect');
            setTimeout(() => {
